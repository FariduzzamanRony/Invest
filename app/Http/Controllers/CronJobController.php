    ...
    public function investmentCronJob()
    {
        ...
        foreach ($ongoingInvestment as $invest) {
            ...
            if ($invest->return_type == 'lifetime') {
                ...
                Txn::new($interest, 0, $interest, 'system', $schema->name . ' Plan Interest', TxnType::Interest, TxnStatus::Success, null,null,$user->id);
                ...
                if ($invest->number_of_period > 0) {
                    if ($invest->number_of_period == 1) {
                        ...
                        if ($invest->capital_back == 1) {
                            ...
                            Txn::new($interest, 0, $interest, 'system', $schema->name . ' Capital Back', TxnType::Refund, TxnStatus::Success,null,null, $user->id);
                        }
                    }
