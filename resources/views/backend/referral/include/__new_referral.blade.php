                    ...
                    <div class="popup-body-text">
                        ...
                        <div class="site-input-groups">
                            ...
                            <input type="text" name="target_amount" oninput="this.value = validateDouble(this.value)"
                                   class="box-input mb-0" placeholder="50" required/>
                        </div>
                        <div class="site-input-groups">
                            <label for="" class="box-input-label">{{ __('Bounty:') }}</label>
                            <input type="text" name="bounty" oninput="this.value = validateDouble(this.value)"
                                   class="box-input mb-0" placeholder="5%" required/>
                        </div>
